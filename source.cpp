...
int main(){
	...
	sqlite3_exec(db, "drop table profile;create table profile ( columnid varchar(50), field_val varchar(255), freq int);",NULL, 0, &db_err);
	...
	ifstream infile("expressor_1k_perf.txt");
